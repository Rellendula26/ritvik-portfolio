...
const BASE_PROJECTS: Project[] = [
  ...
  normalizeProject({
    ...
    status: "shipped",
    oneLine:
      "ESP32 tennis-ball launcher prototype: NEMA 17 feed, dual RS-775 flywheels, MOSFET PWM interface, and breadboard power electronics.",
    overview:
      "I wanted to understand how a ball launcher actually works as an electromechanical system, not just buy one. The build stacked wireless control, motor sequencing, a fused DC rail with MOSFET modules, and modular printed mounts around a NEMA 17 feed and dual RS-775 flywheels. I started on an Arduino Mega with pot speed controllers and Bluetooth, hit unreliable app-level control, and migrated to an ESP32 with MCU-owned PWM instead of patching a bad architecture. It stayed a prototype on purpose: enough to prove multi-motor coordination and power interfacing, not a finished consumer product.",
    techStack: [
      "ESP32",
      "C++",
      "NEMA 17 Stepper",
    ...
    images: [
      ...
      "/projects/tennis-ball-shooter/circuit-v2.jpg",
      "/projects/tennis-ball-shooter/initial-circuit.jpg",
      "/projects/tennis-ball-shooter/motor-controller.jpg",
    ],
    demoVideoUrl: "/projects/tennis-ball-shooter/stepper-motor.mp4",
    date: "2025–2026",
    buildStage: "Engineering prototype",
    keyHighlights: [
      "Migrated from Arduino Mega / Bluetooth to ESP32 after communication reliability became the bottleneck",
      "Replaced pot DC speed controllers with MOSFET modules so firmware owns flywheel PWM",
      "Integrated NEMA 17 indexing with dual RS-775 flywheels on modular printed mounts",
    ],
    architecture: [
      "Mobile app → ESP32 → MOSFET modules + A4988 → RS-775s / NEMA 17 → feed + launch.",
      "Fused external DC rail for actuators; ESP32 stays on the logic side.",
      "Modular mechanical brackets so feed and launcher parts can move during iteration.",
    ],
    challenges: [
      "Arduino Bluetooth worked in short tests and failed as a consistent control path.",
      "Pot speed controllers spun motors but could not take a clean firmware PWM command.",
      "Mechanical layout kept changing while electronics were still unsettled.",
    ],
    lessonsLearned: [
      "Architecture changes beat endless patches on the wrong link layer.",
      "A pot controller proves the motor; a MOSFET module proves the firmware can own the rail.",
      "Breadboard exploration is the right step before freezing a PCB.",
    ],
    technicalNotes: [
      "Prototype, not production-ready.",
      "Next: custom interface PCB, refined launcher mechanics, closed-loop sensing.",
    ],
    nextImprovements: [
      "Custom PCB for power / motor interface",
      "Closed-loop launch / feed sensing",
      "Finish app integration and packaging",
    ],
    media: [
      {
        kind: "video",
        src: "/projects/tennis-ball-shooter/stepper-motor.mp4",
        alt: "ESP32 with A4988, then RS-775 flywheel spinning",
        label: "ESP32 bring-up",
        poster: "/projects/tennis-ball-shooter/chassis.jpg",
        mediaType: "demo",
        featured: true,
        priority: 10,
        caption:
          "ESP32 + A4988 with bulk cap, then yellow printed flywheel on an RS-775.",
      },
      {
        kind: "video",
        src: "/projects/tennis-ball-shooter/v1-circuit.mp4",
        alt: "Mega 2560 driving an A4988 stepper driver",
        label: "Stepper on Mega",
        poster: "/projects/tennis-ball-shooter/initial-circuit.jpg",
        mediaType: "process",
        caption: "Early STEP/DIR path before the ESP32 migration.",
      },
      {
        kind: "video",
        src: "/projects/tennis-ball-shooter/motor-controller.mp4",
        alt: "JZ-MOS and dual-MOSFET modules as received",
        label: "MOSFET modules",
        poster: "/projects/tennis-ball-shooter/motor-controller.jpg",
        mediaType: "process",
        caption: "Switch modules before wiring into the fused DC rail.",
      },
      {
        kind: "image",
        src: "/projects/tennis-ball-shooter/circuit-and-chassis.jpg",
        alt: "Chassis harnessed to ESP32 bench and fused battery rail",
        label: "System on the bench",
        mediaType: "image",
      },
    ],
    tags: ["esp32", "robotics", "stepper", "embedded", "prototype"],
    signal: "Robotics Prototype",
  }),
  normalizeProject({
    id: "P15",
